---
title: "README file for 'Getting and Cleaning Data' Project Course"
...
We will assume the .zip file has already been unzipped in the working directory, meaning that all the files are already accessible in a 'UCI HAR Dataset/' folder
...
This function has one argument : 'test' or 'train' and accordingly reads and binds all the 'test' or 'train' files.
